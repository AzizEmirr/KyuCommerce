...
class OdemeController extends Controller
{
    public function index(){
        return view('frontend.odeme.index');
    }
    public function odeme(){
        ...
        $merchant_id    = '482409';
        $merchant_key   = 'dEbGi317bCFcynaP';
        $merchant_salt  = 'zMmqzrSCt5wXnnJ3';
        ...
        $merchant_ok_url = "https://kyusoftware.cc/odeme/basarili";
        #
        ## Ödeme sürecinde beklenmedik bir hata oluşması durumunda müşterinizin yönlendirileceği sayfa
        ## !!! Bu sayfa siparişi iptal edeceğiniz sayfa değildir! Yalnızca müşterinizi bilgilendireceğiniz sayfadır!
        ## !!! Siparişi iptal edeceğiniz sayfa "Bildirim URL" sayfasıdır (Bakınız: 2.ADIM Klasörü).
        $merchant_fail_url = "https://kyusoftware.cc/odeme/basarisiz";
        #
        ...
        */
        ...
        return view("frontend.odeme.sonuc",compact("token"));
