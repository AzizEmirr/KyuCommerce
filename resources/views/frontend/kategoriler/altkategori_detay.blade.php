...
@section('title') {{ $seo->title }} | {{ $altkategori->altkategori_adi }} @endsection
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">
                                        {{ $altkategori->altkategori_adi }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                    ...
                                    <div class="related__products-item">
                                        <div class="related__products-thumb">
                                            <a href="{{ url('urun/' . $urun->id . '/' . $urun->url) }}"><img
                                                    src="{{ !empty($urun->resim) ? url($urun->resim) : url('uploads/urunler/537x540.png') }}" alt="img"></a>
                                        </div> 
